<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0">Labour Cess Project</h1>
			</div>
			<div class="col-sm-6">
						...
						<div class="card shadow-lg border-0 rounded-4">
							...
							<div class="card-body">
								...
								<ul class="nav nav-tabs tab-style2" id="projectTabs" role="tablist">
									...
									<li class="nav-item">
										<button class="nav-link" id="org-tab" data-bs-toggle="tab" data-bs-target="#org"
										...
										<div class="row">
											<div class="col-md-12">
												...
												<div class="form-group mb-3">
													...
													<span
														class="form-control"><?= h($project->department ?? 'UKBOCW') ?></span>
												</div>
											</div>
										</div>
										<!-- Accordion Inside Title Tab -->
										<div class="accordion mt-4" id="projectAccordion">
													...
													<div class="accordion-body">
														<div class="row">
															<div class="form-group col-md-4">
																...
																<span
																	class="form-control"><?= h($project->construction_area ?? '2122') ?></span>
															</div>
															<div class="form-group col-md-4">
																<label>Estimated End Date</label>
																<span
																	class="form-control"><?= h($project->estimated_end_date ?? '2025-11-30') ?></span>
															</div>
															<div class="form-group col-md-4">
																<label>Estimated Start Date</label>
																<span
																	class="form-control"><?= h($project->estimated_start_date ?? '2025-11-09') ?></span>
															</div>
															<div class="form-group col-md-4">
																<label>Labour Cess Cost (₹)</label>
																<span
																	class="form-control"><?= h($project->cess_cost ?? '') ?></span>
															</div>
															<div class="form-group col-md-4">
																<label>Max Labour Count</label>
																<span
																	class="form-control"><?= h($project->max_labor_count ?? '100') ?></span>
															</div>
															<div class="form-group col-md-4">
																<label>Plot Area (in Sqm)</label>
																<span
																	class="form-control"><?= h($project->plot_area ?? '1233') ?></span>
															</div>
															<div class="form-group col-md-4">
																<label>Property Category</label>
																<span
																	class="form-control"><?= h($project->property_category ?? 'Non-Residential Building') ?></span>
															</div>
															<div class="form-group col-md-4">
																<label>Stage of Construction</label>
																<span
																	class="form-control"><?= h($project->stage_of_construction ?? 'Initial') ?></span>
															</div>
															<div class="form-group col-md-4">
																<label>Total Project Cost (₹)</label>
																<span
																	class="form-control"><?= h($project->total_project_cost ?? '') ?></span>
															</div>
														</div>
													</div>
												</div>
											...
											<div class="accordion-item">
												...
												<div id="collapsePersonal" class="accordion-collapse collapse"
													...
													<div class="accordion-body">
														<div class="row">
															<div class="col-md-4">
																<h4>Email ID of Supervisor/Manager 9
																</h4>
																<p><?= h($project->supervisor_email ?? '') ?>
																</p>
															</div>
															<div class="col-md-4">
																<h4>Mobile No. of Supervisor/Manager
																</h4>
																<p><?= h($project->supervisor_mobile ?? '') ?>
																</p>
															</div>
															<div class="col-md-4">
																<h4>Name of Supervisor/Manager
																</h4>
																<p><?= h($project->supervisor_name ?? '') ?>
																</p>
															</div>
														</div>
													</div>
											...
											<div class="accordion-item">
												<h2 class="accordion-header" id="headingGIS">
													<button class="accordion-button collapsed" type="button"
														data-bs-toggle="collapse" data-bs-target="#collapseGIS">
													GIS Coordinates
													</button>
												</h2>
												<div id="collapseGIS" class="accordion-collapse collapse"
													data-bs-parent="#projectAccordion">
													<div class="accordion-body">
														<div class="row">
															<div class="col-md-4">
																...
																<p><?= h($project->latitude ?? '-') ?>
																</p>
															</div>
															<div class="col-md-4">
																<h4>Longitude
																</h4>
																<p><?= h($project->longitude ?? '-') ?>
																</p>
															</div>
														</div>
													</div>
										...
										<div class="card mb-4 shadow-sm">
											...
											<div class="card-body">
												<div class="row g-3">
													...
													<div class="col-md-3">
														<label class="form-label small text-muted">Old Khasra
														No.</label>
														<div class="form-control">
															<?= h($project->old_khasra_no ?? '-') ?>
														</div>
													</div>
													<div class="col-md-4">
														<label class="form-label small text-muted">Tehsil</label>
														<div class="form-control"><?= h($project->tehsil ?? '-') ?>
														</div>
													</div>
													<div class="col-md-4">
														<label class="form-label small text-muted">Tehsil
														(Other)</label>
														<div class="form-control">
													...
													<div class="col-md-4">
														...
														<div class="form-control">
															<?= h($project->district_name ?? $project->district ?? '-') ?>
														</div>
													</div>
													<div class="col-md-4">
				...
				<div class="tab-pane fade" id="clarification" role="tabpanel">
					...
					<?php foreach ($objections as $obj): ?>
						<div class="border p-3 mb-3">
							...
							<?php endforeach; ?>
							<?php if ($obj->status != 2): ?>
								<?= $this->Form->create(null, ['type'=>'file', 'url'=>['controller'=>'office','action'=>'addObjectionComment',$obj->id]]) ?>
