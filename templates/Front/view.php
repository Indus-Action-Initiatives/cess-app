<div class="container-fluid py-4">
	...
	<div class="card shadow-lg border-0 rounded-4">
		...
		<?php $payment = $this->request->getQuery('payment'); ?>
		<div class="card-body">
			<b><?php echo $project->file_name ?></b>
			<ul class="nav nav-tabs" id="projectTabs" role="tablist">
				<li class="nav-item">
					<button class="nav-link <?= empty($payment) ? 'active' : '' ?>" id="details-tab" data-bs-toggle="tab" data-bs-target="#details" type="button">Details</button>
				</li>
				<li class="nav-item">
				...
				<li class="nav-item">
					<button class="nav-link <?= !empty($payment) ? 'active' : '' ?>" id="payment-tab" data-bs-toggle="tab" data-bs-target="#payment" type="button">Payment</button>
				</li>
			</ul>
			<div class="tab-content mt-4">
				<div class="tab-pane fade  <?= empty($payment) ? 'show active' : '' ?>" id="details" role="tabpanel">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group mb-3">
													...
													<span
														class="form-control"><?= h($project->assessment_name ?? 'NIC TEST') ?></span>
												</div>
												<div class="form-group mb-3">
													<label>Establishment Type</label>
													<span
														class="form-control"><?= h($project->establishment_type ?? 'Complete') ?></span>
												</div>
												<div class="form-group mb-3">
													<label>Description</label>
													<span
														class="form-control"><?= h($project->description ?? 'TESTING') ?></span>
												</div>
												<div class="form-group mb-3">
													<label>Department</label>
													<span
														class="form-control"><?= h($project->department->name ?? 'UKBOCW') ?></span>
												</div>
											</div>
										</div>
													...
													<div class="accordion-body">
														<div class="row">
															<div class="form-group col-md-4">
																...
																<span class="form-control"><?= h($project->construction_area ?? '2122') ?></span>
															</div>
															<div class="form-group col-md-4">
																<label>Estimated End Date</label>
																<span class="form-control"><?= h($project->estimated_end_date ?? '2025-11-30') ?></span>
															</div>
															<div class="form-group col-md-4">
																<label>Estimated Start Date</label>
																<span class="form-control"><?= h($project->estimated_start_date ?? '2025-11-09') ?></span>
															</div>
															<div class="form-group col-md-4">
															...
															<div class="form-group col-md-4">
																...
																<span class="form-control"><?= h($project->max_labor_count ?? '100') ?></span>
															</div>
															<div class="form-group col-md-4">
																<label>Plot Area (in Sqm)</label>
																<span class="form-control"><?= h($project->plot_area ?? '1233') ?></span>
															</div>
															<div class="form-group col-md-4">
																<label>Property Category</label>
																<span class="form-control"><?= h($project->property_category ?? 'Non-Residential Building') ?></span>
															</div>
															<div class="form-group col-md-4">
																<label>Stage of Construction</label>
																<span class="form-control"><?= h($project->stage_of_construction ?? 'Initial') ?></span>
															</div>
															<div class="form-group col-md-4">
											...
											<div class="card-body">
												<div class="row g-3">
													<div class="col-md-6">
														...
														<div class="form-control"><?= h($project->site_location ?? '-') ?></div>
													</div>
													<div class="col-md-3">
														<label class="form-label small text-muted">Property No / Khasra No.</label>
														<div class="form-control"><?= h($project->property_no ?? $project->khasra_number ?? '-') ?></div>
													</div>
													<div class="col-md-3">
													...
													<div class="col-md-4">
														...
														<div class="form-control"><?= h($project->tehsil_other ?? '-') ?></div>
													</div>
													<div class="col-md-4">
														<label class="form-label small text-muted">District</label>
														<div class="form-control"><?= h($project->district->name ?? $project->district->name ?? '-') ?></div>
													</div>
													<div class="col-md-4">
													...
													<div class="col-md-4">
														<label class="form-label small text-muted">City / Village</label>
														<div class="form-control"><?= h($project->city ?? '-') ?></div>
													</div>
													<div class="col-md-4">
														<label class="form-label small text-muted">City / Village (Other)</label>
														<div class="form-control"><?= h($project->city_other ?? '-') ?></div>
													</div>
													<div class="col-md-3">
														<label class="form-label small text-muted">Postal Code</label>
														<div class="form-control"><?= h($project->postal_code ?? $project->pincode ?? '-') ?></div>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<?php foreach ($objections as $obj): ?>
												<div class="border rounded-4 p-3 mt-3 mb-3">
													...
													<?php endforeach; ?>
													<?php if ($obj->status != 2): ?>
														<?= $this->Form->create(null, ['type'=>'file', 'url'=>['controller'=>'front','action'=>'addObjectionComment',$obj->id]]) ?>
				...
				<div class="tab-pane fade <?= !empty($payment) ? 'show active' : '' ?>" id="payment" role="tabpanel">
					...
					<div class="card mb-4">
						<div class="card-header bg-secondary text-white">
							<h5>Registration Charge (Labour Cess)</h5>
						</div>
						<div class="card-body">
							<div class="alert alert-warning">
								To avoid file rejection, please pay the approval fee within <strong>30 days</strong>.
							</div>
							<h4>Total Payable Amount: <span class="text-success">₹<?= h($total_amount ?? 500) ?></span></h4>
							<hr>
							<div class="mt-3 mb-3">
								<?= $this->Html->link('ONLINE PAYMENT (CCAVENUE)', '#', [
									'class' => 'btn btn-danger me-2 disabled',
									'aria-disabled' => 'true',
								...
								<?= $this->Html->link(
									...
									'javascript:void(0);', [
											...
											'id' => 'offlinePaymentBtn'
										]
									) ?>
							</div>
							<?= $this->Form->create(null, ['type' => 'file','url' => ['controller' => 'Front', 'action' => 'payment']]) ?>
							<!-- Hidden section -->
							<div id="payment-section" class="card mt-4" style="display: none;">
								<div class="card-body">
									...
									<div class="row">
										<div class="col-md-3">
											<?= $this->Form->control('payment_mode', [
												...
												'options' => [
														...
														'CASH' => 'Cash',
														'CSC' => 'CSC Wallet',
														'CH' => 'Cheque/Demand Draft/Non Judicial Stamp',
														'NEFT' => 'NEFT / RTGS / IMPS',
														'UPI' => 'UPI',
														'ON-RTI' => 'Online',
														'CASH-R' => 'Cash',
														'POST_R' => 'Postal',
														'CH-RTI' => 'Cheque/Demand Draft/Non Judicial Stamp',
														'NEFT-R' => 'NEFT / RTGS / IMPS'
												],
												'class' => 'form-select',
												'required' => true
												]) ?>
										...
										<div class="col-md-3">
											<?= $this->Form->control('document_reference_no', [
										...
										<div class="col-md-3">
											<?= $this->Form->control('bank_name_branch', [
										...
										<div class="col-md-2">
											<?= $this->Form->control('date_of_payment', [
							...
							<div class="row">
								<div class="col-md-6">
									<?= $this->Form->control('attachment_file_path', [
										'label' => 'Proof of Payment (Registration)',
										'type' => 'file',
										'accept' => '.jpg,.jpeg,.pdf',
										'class' => 'form-control'
										]) ?>
								...
								<div class="mt-4">
									<?= $this->Form->button(__('Complete Offline Payment'), [
					...
					<?php } ?>
					<?php if($project->flow_id == 3){ ?>
					<div class="card mb-4">
						<div class="card-header bg-secondary text-white">
							<h5>Cess Assessment</h5>
						</div>
						<div class="card-body">
							<h4>Assessment Pending at Officer side.</h4>
						</div>
					</div>
					<?php } ?>
					...
					<!-- <div class="card mt-4 shadow-sm">
						<div class="text-center py-4">
							<button class="btn btn-danger" data-toggle="modal" data-target="#objectionModal">Raise Objection</button>
						</div>
					</div> -->
					<?php } ?>
					<?php if($project->flow_id == 4){ ?>
					<div class="card mb-4">
						<div class="card-header bg-secondary text-white">
							<h5>Cess Charge (Labour Cess)</h5>
						</div>
						<div class="card-body">
							<div class="alert alert-warning">
								To avoid file rejection, please pay the approval fee within <strong>30 days</strong>.
							</div>
							<h4>Total Payable Amount: <span class="text-success">₹<?= number_format($project->cess_cost,2) ?></span></h4>
							<hr>
							<div class="mt-3 mb-3">
								<?= $this->Html->link('ONLINE PAYMENT (CCAVENUE)', '#', [
									'class' => 'btn btn-danger me-2 disabled',
							...
							<?= $this->Form->create(null, ['type' => 'file','url' => ['controller' => 'Front', 'action' => 'cessPayment']]) ?>
							<div id="payment-section" class="card mt-4" style="display: none;">
								<div class="card-body">
									<h5>Payment Details</h5>
									<div class="col-md-3">
					...
					<?php } ?>
					<?php if($project->flow_id == 9){ ?>
					<div class="card mb-4">
						<div class="card-header bg-secondary text-white">
							<h5>Cess Charge (Re-Assessment)</h5>
						</div>
						<div class="card-body">
							<div class="alert alert-warning">
								To avoid file rejection, please pay the approval fee within <strong>30 days</strong>.
							</div>
							<h4>Total Payable Amount: <span class="text-success">₹<?= number_format($project->recess_cost,2) ?></span></h4>
							<hr>
							<div class="mt-3 mb-3">
								<?= $this->Html->link('ONLINE PAYMENT (CCAVENUE)', '#', [
									'class' => 'btn btn-danger me-2 disabled',
							...
							<?= $this->Form->create(null, ['type' => 'file','url' => ['controller' => 'Front', 'action' => 'reCessPayment']]) ?>
							<div id="payment-section" class="card mt-4" style="display: none;">
								<div class="card-body">
									<h5>Payment Details</h5>
									<div class="col-md-3">
...
<!-- <div class="modal fade" id="objectionModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <?= $this->Form->create(null, ['type' => 'file', 'url' => ['controller' => 'front', 'action' => 'addObjection', base64_encode($project->id)]]) ?>
...
<script>
	document.getElementById('offlinePaymentBtn').addEventListener('click', function() {
