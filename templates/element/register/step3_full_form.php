...
<table class="table table-bordered table-striped">
	...
	<tbody>
		<tr class="common-row">
			...
			<td><?= $this->Form->control('desc_other', ['label' => false, 'class' => 'form-control']) ?></td>
			<td><?= $this->Form->control('file_other', ['type' => 'file', 'label' => false, 'class' => 'form-control']) ?></td>
		</tr>

		<tr class="company-only">
			<td>2</td>
			<td>Company Registration No</td>
			<td><?= $this->Form->control('desc_company', ['label' => false, 'class' => 'form-control']) ?></td>
			<td><?= $this->Form->control('file_company', ['type' => 'file', 'label' => false, 'class' => 'form-control']) ?></td>
		</tr>
