	...
	<body class="hold-transition sidebar-mini layout-fixed">
		<div class="wrapper">
			...
			<nav class="main-header navbar navbar-expand navbar-white navbar-light">
				...
				<h3 class="text-center" style="color: red;margin-top: 10px; text-align: center;">Deputy Labour Commissioner (Board)</h3>
				<?php $session = $this->request->getSession(); ?>
				<ul class="navbar-nav ml-auto">
					<li class="nav-item dropdown">
						<a class="nav-link" data-toggle="dropdown" href="javascript:void(0)">
							<i class="far fa-user"></i> &nbsp; <?php echo $session->read('administrator.username') ?>
						</a>
