...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <h3 class="text-center" style="color: red;margin-top: 40px;text-decoration: underline;">Registration Payment</h3>
        <!-- Navbar -->
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    $off_name = $session->read('front.off_name');
                    ?>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <!-- <a class="dropdown-item" href="javascript:void(0);"><i class="fas fa-users mr-2"></i> <strong>Name : <?= h($off_name) ?> </strong> </a> -->
