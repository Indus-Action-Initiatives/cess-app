...
<h3 class="text-center" style="color: red;margin-top: 40px;text-decoration: underline;">Store Dashboard</h3>
  <!-- Navbar -->
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a class="dropdown-item" href="<?php echo webURL?>store/changePassword"><i class="fas fa-edit mr-2"></i> Change Password</a>
  ...
  <!-- /.navbar -->
<?php echo $this->element('storesidebar');?>
